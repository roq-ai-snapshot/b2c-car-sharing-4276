...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'car.create': {
    ...
    key: 'new-car-added',
    tenantPath: ['company', 'car'],
    userPath: [],
  },
  'car.update': {
    roles: ['owner', 'fleet-manager'],
    key: 'car-details-updated',
    tenantPath: ['company', 'car'],
    userPath: [],
  },
  'car.delete': { roles: ['owner', 'fleet-manager'], key: 'car-removed', tenantPath: ['company', 'car'], userPath: [] },
  'booking.create': {
...
const ownerRoles: string[] = ['fleet-manager'];
