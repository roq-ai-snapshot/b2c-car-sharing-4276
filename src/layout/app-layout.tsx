...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['fleet-manager', 'owner', 'admin'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Admins', path: '/admins', entity: 'admin', service: AccessServiceEnum.PROJECT, icon: FiShieldOff },
    ...
    { name: 'Owners', path: '/owners', entity: 'owner', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
