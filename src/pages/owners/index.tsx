...
import { getOwners, deleteOwnerById } from 'apiSdk/owners';
...
export function OwnerListPage(props: OwnerListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<OwnerInterface>>(
    () => `/owners?params=${JSON.stringify(params)}`,
    fetcher,
  );
